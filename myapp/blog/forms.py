...
class LoginForm(forms.Form):
    ...
    def clean(self):
        ...
        if username and password:
            ...
            if user is None:
                raise forms.ValidationError("Invalid UserName & Password") # non field errors
...
class ForgotPasswordForm(forms.Form):
    ...
    def clean(self):
        ...
        if not User.objects.filter(email=email).exists(): # exists checking the data values it has or has not
